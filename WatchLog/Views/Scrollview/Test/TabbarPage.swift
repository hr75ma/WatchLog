...
//    @State private var refreshEntryID: UUID = UUID()
//
//    @State private var scrollPos: UUID = UUID()
//
...
//            } else {
//                
//                ForEach(logEntryUUIDContainer.logEntryBookDay.logEntriesSorted) { entry in
//
//                        LogBookEntryShowWrapperView(watchLogEntry: entry.getWatchLogEntry())
//                            .tag(entry.id)
//                            .id(refreshEntryID)
...
//        
//        .onTapGesture {
//            if logEntryUUIDContainer.logEntryBookDay.watchLogBookEntries!.count > 0 {
...
//            maxHeight: .infinity
//        )
//        .onChange(of: scrollPos) {
////            print("index  - \(scrollPos.uuidString)")
...
////            displayedLogEntryUUID.id = scrollPos
////            logEntryUUIDContainer.logEntryUUID = scrollPos
//            logEntryUUID = scrollPos
//            //numberOfEntry = index + 1
//        }
//        .onAppear {
//            Task { @MainActor in
//
//                print("onappear scroll to: \(logEntryUUIDContainer.logEntryUUID)")
//                withAnimation {
//                    Task {
...
//                            logEntryUUID = logEntryUUIDContainer.logEntryUUID
//                        }
//                        
//                    }
//                    
